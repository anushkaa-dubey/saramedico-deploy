                              ...
                              <span>
                                {
                                  app.patient_name ||
                                  app.patientName ||
                                  (app.patient && (app.patient.full_name || (app.patient.first_name ? `${app.patient.first_name} ${app.patient.last_name}` : null))) ||
                                  (patientsMap[app.patient_id] && (patientsMap[app.patient_id].name || patientsMap[app.patient_id].full_name)) ||
