                            ...
                            <tbody>
                                {doctors.map(doc => (
                                    <tr key={doc.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                        <td style={{ padding: '16px 12px', fontWeight: '600', color: '#0f172a', whiteSpace: 'nowrap' }}>{doc.name}</td>
                                        <td style={{ padding: '16px 12px', color: '#64748b', whiteSpace: 'nowrap' }}>{doc.specialty}</td>
