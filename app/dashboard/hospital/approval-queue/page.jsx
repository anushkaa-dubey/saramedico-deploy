            ...
            <div className={styles.contentWrapper}>
                ...
                <div className={styles.card} style={{ border: 'none', background: '#ffffff', padding: '0', borderRadius: '16px', overflow: 'hidden' }}>
                    <div style={{ padding: '24px', borderBottom: '1px solid #f1f5f9' }}>
                        <div className={styles.filterButtonRow} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
                            ...
                            <div className={styles.filterButtonRow} style={{ display: 'flex', gap: '8px' }}>
                        ...
                        <table className={styles.activityTable} style={{ fontSize: '13px' }}>
                            <thead>
                                <tr className={styles.activityHeader}>
                                    ...
                                    <th style={{ color: '#94a3b8', whiteSpace: 'nowrap' }}>SESSION ID</th>
